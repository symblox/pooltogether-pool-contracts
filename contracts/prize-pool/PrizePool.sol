  ...
  TokenControllerInterface
{
  ...
  function initialize(
    ...
    emit Initialized(address(_reserveRegistry), maxExitFeeMantissa, maxTimelockDuration);
  }
  ...
  function captureAwardBalance() external override nonReentrant returns (uint256) {
    ...
    uint256 unaccountedPrizeBalance =
      (totalInterest > _currentAwardBalance) ? totalInterest.sub(_currentAwardBalance) : 0;
  ...
  function _estimateCreditAccrualTime(
    ...
    uint256 accruedPerSecond =
      FixedPoint.multiplyUintByMantissa(_principal, _tokenCreditPlans[_controlledToken].creditRateMantissa);
  ...
  function _applyCreditLimit(
    ...
    uint256 creditLimit =
      FixedPoint.multiplyUintByMantissa(controlledTokenBalance, _tokenCreditPlans[controlledToken].creditLimitMantissa);
  ...
  function _calculateAccruedCredit(
    ...
    uint256 creditPerSecond =
      FixedPoint.multiplyUintByMantissa(controlledTokenBalance, _tokenCreditPlans[controlledToken].creditRateMantissa);
  ...
  function timelockBalanceOf(address user) external view override returns (uint256) {
